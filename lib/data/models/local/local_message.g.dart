...
const LocalMessageSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'deliveryStatus': PropertySchema(
      ...
      type: IsarType.byte,
      enumMap: _LocalMessagedeliveryStatusEnumValueMap,
    ),
...
LocalMessage _localMessageDeserialize(
  ...
  final object = LocalMessage(
    ...
    deliveryStatus: _LocalMessagedeliveryStatusValueEnumMap[
            reader.readByteOrNull(offsets[1])] ??
        MessageStatus.sending,
    isOutgoing: reader.readBool(offsets[2]),
    messageId: reader.readString(offsets[3]),
    payload: reader.readString(offsets[4]),
    receiverId: reader.readString(offsets[5]),
...
P _localMessageDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 1:
      return (_LocalMessagedeliveryStatusValueEnumMap[
...
const _LocalMessagedeliveryStatusEnumValueMap = {
  'sending': 0,
  'sent': 1,
  'delivered': 2,
  'failed': 3,
};
const _LocalMessagedeliveryStatusValueEnumMap = {
...
extension LocalMessageQueryFilter
  ...
  QueryBuilder<LocalMessage, LocalMessage, QAfterFilterCondition>
      deliveryStatusEqualTo(MessageStatus value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
...
extension LocalMessageQuerySortBy
  ...
  QueryBuilder<LocalMessage, LocalMessage, QAfterSortBy> sortByIsOutgoing() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<LocalMessage, LocalMessage, QAfterSortBy> sortByPayload() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'payload', Sort.asc);
    });
  }

  QueryBuilder<LocalMessage, LocalMessage, QAfterSortBy> sortByPayloadDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension LocalMessageQuerySortThenBy
  ...
  QueryBuilder<LocalMessage, LocalMessage, QAfterSortBy> thenByIsOutgoing() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isOutgoing', Sort.asc);
    });
  }
  ...
  QueryBuilder<LocalMessage, LocalMessage, QAfterSortBy> thenByPayload() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'payload', Sort.asc);
    });
  }

  QueryBuilder<LocalMessage, LocalMessage, QAfterSortBy> thenByPayloadDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'payload', Sort.desc);
    });
  }
...
extension LocalMessageQueryWhereDistinct
  ...
  QueryBuilder<LocalMessage, LocalMessage, QDistinct> distinctByIsOutgoing() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<LocalMessage, LocalMessage, QDistinct> distinctByPayload(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension LocalMessageQueryProperty
  ...
  QueryBuilder<LocalMessage, MessageStatus, QQueryOperations>
  ...
  QueryBuilder<LocalMessage, bool, QQueryOperations> isOutgoingProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<LocalMessage, String, QQueryOperations> payloadProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<LocalMessage, int, QQueryOperations> timestampProperty() {
    return QueryBuilder.apply(this, (query) {
